      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 w-full relative">
        <div className="fade-up" style={{ animationDelay: '0.1s' }}>
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-red-600/10 border border-red-600/30 rounded-full mb-6">
            ...
            <span className="text-xs font-bold tracking-wider text-red-300">CAMP BBQ • SHIP TẬN NƠI</span>
          </div>
        </div>
        ...
        >
          ...
          <span className="block italic font-light text-stone-400 text-[12vw] md:text-[8vw] lg:text-[7vw]">ngay.</span>
        </h1>
        ...
        {/* Features bar */}
        <div className="mt-16 md:mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-2 border-t border-stone-800 pt-8 fade-up" style={{ animationDelay: '0.6s' }}>
          {features.map((f, i) => (
            <div key={i} className="flex items-start gap-3">
              <f.icon size={20} className="text-red-500 mt-0.5 shrink-0" strokeWidth={2} />
              <div>
